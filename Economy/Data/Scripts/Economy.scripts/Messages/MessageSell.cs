                ...
                case SellAction.Create:
                    {
                        ...
                        if (SellToMerchant || UseBankBuyPrice)
                        {
                            ...
                            if (UseBankBuyPrice)
                                ...
                                if (SpaceCredit || !EconomyScript.Instance.ServerConfig.PriceScaling || accountToBuy.SteamId != EconomyConsts.NpcMerchantId) ItemPrice = marketItem.BuyPrice; else ItemPrice = EconDataManager.PriceAdjust(marketItem, marketItem.Quantity, PricingBias.Buy);
